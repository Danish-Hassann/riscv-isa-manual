...
+
[[norm:mseccfg-MML_shared-region_data_access]]
...
+
[[norm:mseccfg-MML_shared-region_code_access]]
...
+
[[norm:mseccfg-MML_shared-region_readonly_access]]
